  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content={`https://webstore-acrowd.vercel.app/category/${category}`} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content={`${category.charAt(0).toUpperCase() + category.slice(1)} - Shop`} />
        <meta property="og:description" content={`Browse products in the ${category} category.`} />
        <meta property="og:image" content={`https://ogcdn.net/6064b869-74ed-4eb9-b76c-0b701ffe7e6b/v4/webstore-acrowd.vercel.app/Buy%20${encodeURIComponent(defaultProductName)}%20-%20Our%20Shop/${encodeURIComponent(firstProductImage)}%20/og.png`} />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta property="twitter:domain" content="webstore-acrowd.vercel.app" />
        <meta property="twitter:url" content={`https://webstore-acrowd.vercel.app/category/${category}`} />
        <meta name="twitter:title" content={`${category.charAt(0).toUpperCase() + category.slice(1)} - Shop`} />
        <meta name="twitter:description" content={`Browse products in the ${category} category.`} />
        <meta name="twitter:image" content={`https://ogcdn.net/6064b869-74ed-4eb9-b76c-0b701ffe7e6b/v4/webstore-acrowd.vercel.app/Buy%20${encodeURIComponent(defaultProductName)}%20-%20Our%20Shop/${encodeURIComponent(firstProductImage)}%20/og.png`} />
      </Head>
